...
> SKN26 4th Project · 프로젝트 주제 및 기술 스택 미정
...
### 1.1 소개
4차 프로젝트 소개는 현재 **미정**입니다.  
프로젝트 주제 확정 후 본 섹션을 업데이트할 예정입니다.

### 1.2 문제 정의
문제 정의는 현재 **미정**입니다.  
팀 논의를 통해 해결하려는 문제를 확정 후 작성 예정입니다.

### 1.3 목표
- 프로젝트 목표는 현재 **미정**입니다.
- 주제 및 요구사항 확정 후 구체적인 목표를 정의할 예정입니다.
...
### 5.1 수집
- 데이터 수집 방식은 현재 **미정**입니다.

### 5.2 전처리
- 데이터 전처리 방식은 현재 **미정**입니다.

### 5.3 저장
- 데이터 저장소 및 스키마는 현재 **미정**입니다.

### 5.4 활용 (Runtime)
```
[시스템 런타임 플로우 미정]
프로젝트 주제 확정 후 파이프라인을 정의할 예정입니다.
```
...
```python
# Python API 사용 예시는 미정입니다.
```

### 8.4 RAG 기반 LLM·벡터DB 연동 구현 코드

- 구현 코드는 현재 **미정**입니다.
- 프로젝트 방향과 아키텍처 확정 후 본 섹션을 업데이트할 예정입니다.
